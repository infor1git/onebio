...
<main class="links-wrapper">
    ...
    if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); 
        ...
        // --- CONTEÚDO HTML/IFRAME (FORÇADO A SAIR DA LARGURA) ---
        if ($type === 'raw_html') {
        ...
        // --- BOTÕES ---
            ...
            $icon_style = ($saved_color) ? "color: " . esc_attr($saved_color) . ";" : ""; 
            ...
            ?>
            <a href="<?php echo $href; ?>" class="link-card" target="<?php echo $target; ?>" onclick="<?php echo $onclick; ?>">
                <div class="icon-box" style="<?php echo $icon_style; ?>">
